...
const ids = ['VideoUrlLow', 'VideoUrlHigh', 'VideoHLS-250p', 'VideoHLS-360p', 'VideoHLS-480p', 'VideoHLS-720p']
...
var exec = async function(params, opts){
	...
	logger.info('debug: VideoUrlLow ' + VideoUrlLow)
	...
	logger.info('debug: VideoUrlHigh ' + VideoUrlHigh)
	...
	logger.info('debug: VideoHLS ' + VideoHLS)
	logger.info('debug: 包含多个清晰度媒体源')
