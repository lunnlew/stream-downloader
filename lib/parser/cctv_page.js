...
const ids = ['hls', 'lowChapters','chapters', 'chapters2', 'chapters3', 'chapters4']
const id_2_profile = {'hls':'simple', 'lowChapters':'320x180_200kb/s', 'chapters':'480x270_450kb/s', 'chapters2': '640x360_850kb/s','chapters3': '1280x720_1200kb/s', 'chapters4': '1280x720_2000kb/s'}
...
var exec = async function(params, opts){
	...
	streams['hls'] = {
		...
		'format':'mp4',
        'isRemote':true,
        'video_profile':videoType=='cctv4k'?'4k':id_2_profile['hls'],
		'src': [v_json['hls_url']],
		"merge":true,
		'size':0
	}
