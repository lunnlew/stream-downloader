...
var exec = async function(params, opts){
    ...
    let url_macth = params.url.match(/\w+.cctv.com\/live\/(\w+)/iu)
    let sid = url_macth[1]
    logger.info("sid " + sid)
    //cctv1,cctv2,cctv3,cctv4,cctv5,cctv5plus,cctv6,,cctv7,,cctv8,,cctv9
    //,cctv10,cctv11,cctv12,cctv13,cctvchild,cctv15,cctv17
    //,cctvamerica,cctveurope
