...
var buildMusicParams = function(sid) {
    let i2x = {
        csrf_token: "",
        encodeType: "aac",
        ids: '[' + sid + ']',
    ...
    var bUS3x = d(JSON.stringify(i2x), bry5D(["流泪", "强"]), bry5D(Sj7c.md), bry5D(["爱心", "女孩", "惊恐", "大笑"]));
    return {
...
var buildMusicDetailParams = function(sid) {
    let i2x = {
        c: '[{"id":"' + sid + '"}]',
        csrf_token: "",
        id: sid.toString()
...
var buildMvParams = function(sid, part_format_id = 1080) {
    let i2x = {
        csrf_token: "",
        id: sid.toString(),
        r: part_format_id
...
var buildMvDetailParams = function(sid) {
    let i2x = {
        id: sid.toString(),
        csrf_token: "",
        type: "MP4"
...
exports = module.exports = { asrsea: d, ecnonasr: e, buildMusicParams, buildMusicDetailParams, buildMvParams, buildMvDetailParams }