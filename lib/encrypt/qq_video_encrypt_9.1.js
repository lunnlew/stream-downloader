...
///////////////////////////////// load wasm ///////////////////////////////////////
const fs = require('fs');
var wasm_data = fs.readFileSync(path.join(__dirname, './qq_video_encrypt_ckey.wasm'))
...
// encryptVer = "9.1"
function getCkeyV91(platform, appVer, vid, empty_str = "", guid, tm) {
...
exports = module.exports = { getCkeyV91, createGUID }