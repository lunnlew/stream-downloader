...
const unlink = require(path.join(__dirname,'./unlink'))
...
var exec = async function(ffpath, opts){
	...
	try{
		...
		if(ffresult!='ok')
		{
			ffresult = await tryDownload(opts,"http://soft.qskjgz.com/%E5%AA%92%E4%BD%93%E5%B7%A5%E5%85%B7/ffmpeg/ffmpeg-20190722-817235b-win64-static.zip")
		}
	}catch(err){
		console.log("debug: trying download ffmpeg ")
		ffresult = await tryDownload(opts,"http://soft.qskjgz.com/%E5%AA%92%E4%BD%93%E5%B7%A5%E5%85%B7/ffmpeg/ffmpeg-20190722-817235b-win64-static.zip")
	}
